define(['initialize_facebook', 'authentication', 'user', 'data/seed_data', 'data/scrip_promotion_dao', 'ui/seed_data', 'ui/scrip_search', 'ui/scrip_promotion', 'parse'], function(InitializeFacebook, Authentication, User, SeedData, ScripPromotionDao, UiSeedData, UiScripSearch, UiScripPromotion) {
  var init;
  init = function() {
