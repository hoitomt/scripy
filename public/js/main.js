...
define(['data/authentication', 'data/user', 'data/seed_data', 'data/scrip_promotion_dao', 'data/session', 'ui/seed_data', 'ui/scrip_search', 'ui/scrip_promotion', 'ui/login_links', 'ui/page_content', 'parse'], function(Authentication, User, SeedData, ScripPromotionDao, Session, UiSeedData, UiScripSearch, UiScripPromotion, UiLoginLinks, UiPageContent) {
  var init;
  init = function() {
